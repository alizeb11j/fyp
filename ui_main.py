...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # self.grECG1 = PlotWidget(self.frame_4)
        # self.grECG1.setFrameShape(QtGui.QFrame.NoFrame)
        # self.grECG1.setFrameShadow(QtGui.QFrame.Plain)
        # self.grECG1.setLineWidth(0)
        # self.grECG1.setObjectName(_fromUtf8("grECG1"))
        # self.verticalLayout_3.addWidget(self.grECG1)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "ECG From Sensor", None))
        self.label_3.setText(_translate("MainWindow", "ECG From Sensor", None))
        self.label_4.setText(_translate("MainWindow", "   open-source live soundcard monitor with realtime iFFT filtering ", None))
        self.btnSite.setText(_translate("MainWindow", "", None))
        ...
        self.lineTitle.setText(_translate("MainWindow", "ECG From Sensor", None))
        self.btnPause.setText(_translate("MainWindow", "Pause", None))
        self.btnSave.setText(_translate("MainWindow", "Save Figure", None))
        # self.lineTitle.setText(_translate("MainWindow","Classified Beats",None))
